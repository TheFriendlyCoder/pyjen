...
from ..utils import clean_view, async_assert


def test_create_sectioned_view(jenkins_env):
    jk = Jenkins(jenkins_env["url"], (jenkins_env["admin_user"], jenkins_env["admin_token"]))
    expected_view_name = "test_create_sectioned_view"
    v = jk.create_view(expected_view_name, "hudson.plugins.sectioned_view.SectionedView")
...
def test_add_list_section(jenkins_env):
    jk = Jenkins(jenkins_env["url"], (jenkins_env["admin_user"], jenkins_env["admin_token"]))
    v = jk.create_view("test_add_list_section", "hudson.plugins.sectioned_view.SectionedView")
    with clean_view(v):
...
def test_list_section_no_regex(jenkins_env):
    jk = Jenkins(jenkins_env["url"], (jenkins_env["admin_user"], jenkins_env["admin_token"]))
    v = jk.create_view("test_list_section_no_regex", "hudson.plugins.sectioned_view.SectionedView")
    with clean_view(v):
...
def test_list_section_set_regex(jenkins_env):
    jk = Jenkins(jenkins_env["url"], (jenkins_env["admin_user"], jenkins_env["admin_token"]))
    v = jk.create_view("test_list_section_set_regex", "hudson.plugins.sectioned_view.SectionedView")
    with clean_view(v):
        v.add_section("hudson.plugins.sectioned_view.ListViewSection", "MyNewSection")
...
def test_add_text_section(jenkins_env):
    jk = Jenkins(jenkins_env["url"], (jenkins_env["admin_user"], jenkins_env["admin_token"]))
    v = jk.create_view("test_add_text_section", "hudson.plugins.sectioned_view.SectionedView")
    with clean_view(v):
        expected_name = "MyNewSection"

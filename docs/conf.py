...
project = "pyjen"
_proj_dir = os.path.join(_src_dir, project)
# TODO: Parse version from toml file
with open(os.path.join(_proj_dir, "version.py")) as prop_file:
    _data = ast.parse(prop_file.read())
    release = version = _data.body[0].value.s
...
latex_documents = [
  ('index', 'PyJen.tex', 'PyJen Documentation',
...
man_pages = [
    ('index', 'pyjen', 'PyJen Documentation',
     ['Kevin S. Phillips'], 1)
]
...
texinfo_documents = [
  ('index', 'PyJen', 'PyJen Documentation',
   'Kevin S. Phillips', 'PyJen', 'One line description of project.',
   'Miscellaneous'),
]
